...
const jsonLdData: WithContext<Blog> = {
  ...
  description:
    "웹 개발, AI 기술, 소프트웨어 아키텍처에 대한 기술 블로그입니다. React, Next.js, AI 기술 등 다양한 개발 경험을 공유합니다.",
  url: "https://kamilereon.net",
  author: {
    "@type": "Person",
    name: "kamilereon",
    url: "https://github.com/windopper",
    sameAs: ["https://github.com/windopper"],
  },
  publisher: {
    "@type": "Organization",
    name: "kamilereon",
...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col gap-4 py-32 px-8 items-center justify-center min-h-screen">
      ...
      <div className="flex flex-col z-50 w-full max-w-4xl">
        <div className="flex flex-row justify-between items-center text-sm ">
          <span className="font-bold py-4">최근 메모</span>
        </div>
        <MemoList memos={latest4Memos} />
      </div>
